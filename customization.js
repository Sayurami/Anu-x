...
┏━━━━❮📝 ᴅᴇᴛᴇʟᴇꜱ 📝❯━━━
┃🗣️ 𝚄𝚜𝚎𝚛 : ${pushname}
┃🤖 𝙱𝚘𝚝 : GOJO 𝐌𝙳 V${packageJson.version}
...
Twitter URL: ${q}
  ...
  //=================main==================================
  ALIVEIMG: "https://raw.githubusercontent.com/gojo18888/Photo-video-/refs/heads/main/file_000000003a2861fd8da00091a32a065a.png",
  ALIVEVOICE: "https://files.catbox.moe/ip9us5.mp3",
  ALIVEMSG: function (hostname, config, pushname, runtime) {
    return `
🧚‍♂️⃟🩵 GOJO 𝐌𝙳 𝐀𝐋𝐈𝐕𝐄 𝐒𝐓𝐀𝐓𝐔𝐒 🧚‍♂️⃟🩵
...
🎧 Enjoy your music with 𝐒𝙷𝙰𝙶𝙴𝙴 𝐌𝙳
❤️ Created by Dineth
        `.trim();
  },
  YTMP3: function (data) {
...
🎬 *Enjoy the video brought to you by GOJO 𝐌𝙳 Bot!* 
        `.trim();
  },
  VIDEO: function (data) {
    return `
